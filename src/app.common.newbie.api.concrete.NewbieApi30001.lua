slot2 = "NewbieApi30001"
NewbieApi30001 = class(slot1)

NewbieApi30001.ctor = function (slot0)
	slot4 = BaseNewbieApi
...
NewbieApi30001.start = function (slot0)
	slot4 = TIP_CHARGE_FINISH
...
NewbieApi30001.onBtnClick = function (slot0)
	slot3 = slot0

	slot0.finish(slot2)
end

NewbieApi30001.destroy = function (slot0)
	slot4 = TIP_CHARGE_FINISH
