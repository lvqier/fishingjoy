slot0 = class_C("FishVisualLight", ClassLoader:aquireClass("FishVisual"))
...
slot0.loadVisualFish = function (slot0, slot1)
	...
	slot0._cycleSpine = sp.SkeletonAnimation:create(ENUM.FishLightEffect.Effect.json, ENUM.FishLightEffect.Effect.atals, slot1.Effect[1].Scale)
...
slot0.changeDeadAction = function (slot0)
	...
	slot0._cycleSpine:registerSpineEventHandler(c_func(slot8, slot0._cycleSpine), sp.EventType.ANIMATION_END)
end
