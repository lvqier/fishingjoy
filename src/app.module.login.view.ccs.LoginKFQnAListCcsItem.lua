LoginKFQnAListCcsItem = class("LoginKFQnAListCcsItem")

LoginKFQnAListCcsItem.onCreationComplete = function (slot0)
...
LoginKFQnAListCcsItem.onCurSelectedChanged = function (slot0)
...
LoginKFQnAListCcsItem.getEndGap = function (slot0)
	return slot0._heightExtra
end

LoginKFQnAListCcsItem.onClick = function (slot0, slot1)
...
LoginKFQnAListCcsItem.updateView = function (slot0)
	if slot0._data then
		slot0.layerTitle.txtTitle_tf:setHtmlText(slot0._data.title)
	end
end

LoginKFQnAListCcsItem.destroy = function (slot0)
