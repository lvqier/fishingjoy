slot2 = "DdzReportResultCcsItem"
DdzReportResultCcsItem = class(slot1)

DdzReportResultCcsItem.onCreationComplete = function (slot0)
	slot9 = false
...
DdzReportResultCcsItem.updateColorAndPlistInfo = function (slot0)
...
DdzReportResultCcsItem.onDataChanged = function (slot0)
	if slot0._data then
		...
		slot7 = slot0._viewChairId == DDZ_VIEW_CHAIRID_ME
		...
		if slot0.model._reportIncludeMySelf and slot0._viewChairId == DDZ_VIEW_CHAIRID_ME then
			slot7 = Hero
