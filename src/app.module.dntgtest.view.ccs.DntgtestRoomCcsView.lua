slot2 = "DntgtestRoomCcsView"
DntgtestRoomCcsView = class(slot1)
slot0 = {
	{
		hero = "res/gameres/module/dntgtest/roomSpine/dly/hero/dntg_dly_b1",
		backBg = "res/gameres/module/dntgtest/roomSpine/dly/bg/denglongyu2DUI_a2",
		frontBg = "res/gameres/module/dntgtest/roomSpine/dly/bg/denglongyu2DUI_a1"
	},
	{},
	{
		hero = "res/gameres/module/dntgtest/roomSpine/wugui/hero/dntg_wugui",
		backBg = "res/gameres/module/dntgtest/roomSpine/wugui/bg/wugui_Back_background",
		frontBg = "res/gameres/module/dntgtest/roomSpine/wugui/bg/wugui_Fore_background"
	},
	{
		hero = "res/gameres/module/dntgtest/roomSpine/sy/hero/dntg_sy_b",
		backBg = "res/gameres/module/dntgtest/roomSpine/sy/bg/shayu2DUI_a2",
		frontBg = "res/gameres/module/dntgtest/roomSpine/sy/bg/shayu2DUI_a1"
	},
	{
		hero = "res/gameres/module/dntgtest/roomSpine/yudi/hero/dntg_yd",
		backBg = "res/gameres/module/dntgtest/roomSpine/yudi/bg/yd_Back_background",
		frontBg = "res/gameres/module/dntgtest/roomSpine/yudi/bg/yd_Fore_background"
	},
	{
		hero = "res/gameres/module/dntgtest/roomSpine/sunwukong/hero/dntg_wk",
		backBg = "res/gameres/module/dntgtest/roomSpine/sunwukong/bg/wukong_Back_background",
		frontBg = "res/gameres/module/dntgtest/roomSpine/sunwukong/bg/wukong_Fore_background"
	}
}

DntgtestRoomCcsView.onCreationComplete = function (slot0)
...
DntgtestRoomCcsView.onBottomShowComplete = function (slot0)
...
DntgtestRoomCcsView.alignComponent = function (slot0)
	slot6 = 80
...
DntgtestRoomCcsView.onButton_Click = function (slot0, slot1, slot2, slot3)
...
DntgtestRoomCcsView.updateRoomList = function (slot0)
	slot4 = slot0.model
	...
	while slot2 <= 10 do
		...
		if slot0._roomBtnsDic[slot2] then
			...
			if slot5 then
				...
				if slot2 == 6 then
					slot9 = slot6
					slot13 = slot0._roomBtnInitPoses[slot3].y

					slot6.setPosition(slot8, cc.p(slot11, slot0._roomBtnInitPoses[slot3].x + 10))
				else
					slot10 = slot0._roomBtnInitPoses[slot3]
...
DntgtestRoomCcsView.playEnterAnimation = function (slot0)
	slot4 = true
...
DntgtestRoomCcsView.addSpineAni = function (slot0, slot1, slot2)
	if not slot1 then
		return
	end
	...
	if sp.SkeletonAnimation.create(slot7, sp.SkeletonAnimation, slot5 .. ".json", slot5 .. ".atlas") ~= nil then
		slot12 = true

		slot6.setAnimation(slot8, slot6, 0, "animation")

		slot10 = display.CENTER

		slot6.setAnchorPoint(slot8, slot6)

		slot9 = slot6
		slot13 = -220

		slot6.setPosition(slot8, cc.p("animation", 5))
	...
	if sp.SkeletonAnimation.create(slot8, sp.SkeletonAnimation, slot3 .. ".json", slot3 .. ".atlas") ~= nil then
		slot13 = true
...
DntgtestRoomCcsView.updateRoomBtn = function (slot0, slot1, slot2, slot3)
	if slot3 == 1 and slot1.imgFree then
		...
		slot8 = "common/Dntg_Room_jd1.png"
		slot12 = 4
...
DntgtestRoomCcsView.onBtnClick = function (slot0, slot1, slot2)
...
DntgtestRoomCcsView.onNickNameChanged = function (slot0)
	slot7 = 2
	slot5 = StringUtil.truncate(Hero, Hero.getPNickName(slot2), 20, nil)

	slot0.layerBottom.txtName.setString(Hero, slot0.layerBottom.txtName)
end

DntgtestRoomCcsView.onUserScoreChanged = function (slot0)
	slot3 = slot0.layerBottom.scoreInfo
	slot10 = Hero

	slot0.layerBottom.scoreInfo.setStrTxt(slot2, MathUtil.cookNumWithComma(parseInt(Hero.getUserScore(slot9))))
...
DntgtestRoomCcsView.destroy = function (slot0)
	if NewbieUI then
		slot4 = slot0.model
