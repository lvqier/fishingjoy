PdkModel.initReportModel = function (slot0)
...
PdkModel.getBeiShuByTimeIdx = function (slot0, slot1)
	slot5 = slot1

	return slot0._bct2BeishuConfig[slot0.getBctByTimeIdx(slot3, slot0)]
end

PdkModel.onReportRawDataChanged = function (slot0)
...
PdkModel.initReportViewChairIdDic = function (slot0)
...
PdkModel.getBctByTimeIdx = function (slot0, slot1)
