CandyDispatcher = CandyDispatcher or {}
slot0 = print

CandyDispatcher.init = function (slot0)
	slot0._eventListenerArr = {}
	slot0._objectEvent = {}
end

CandyDispatcher.addEventListener = function (slot0, slot1, slot2, slot3, slot4, slot5)
...
CandyDispatcher.dispatchEvent = function (slot0, slot1, slot2)
...
CandyDispatcher.removeEventListener = function (slot0, slot1, slot2, slot3)
...
CandyDispatcher.clearOneObjEvent = function (slot0, slot1)
...
CandyDispatcher.clearEvent = function (slot0, slot1)
	slot0._eventListenerArr[slot1] = nil
end

CandyDispatcher.initEvent = function (slot0)
	slot0._eventListenerArr = {}
end

CandyDispatcher.clearAllEvent = function (slot0)
	slot0._eventListenerArr = {}
end
