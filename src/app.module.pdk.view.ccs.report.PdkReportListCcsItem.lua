slot2 = "PdkReportListCcsItem"
PdkReportListCcsItem = class(slot1)

PdkReportListCcsItem.onCreationComplete = function (slot0)
	slot4 = CcsListViewItem

	ClassUtil.extends(slot2, slot0)
end

PdkReportListCcsItem.updateView = function (slot0)
	if slot0._data then
		...
		slot0.txtMark_tf.setHtmlText(slot4, HtmlUtil.createArtNumDotSign(slot7, parseInt(slot9), (parseInt(slot2) > 0 and "#plist_pdk_font_result_1_%s.png") or "#plist_pdk_font_result_3_%s.png", nil, nil, nil, nil, nil, nil))
...
PdkReportListCcsItem.getPushZoomView = function (slot0)
	return nil
end

PdkReportListCcsItem.onBtnClick = function (slot0, slot1)
...
PdkReportListCcsItem.handleScrollBtns = function (slot0, slot1)
...
PdkReportListCcsItem.destroy = function (slot0)
