...
slot1 = class_C("CannonTop", function (...)
	return slot0:create(...)
end)
...
slot1.arrangeCannon = function (slot0)
	slot0._cannon:setRotation(180)
...
slot1.setPosition = function (slot0, slot1)
	cc.Node.setPosition(slot0, slot1.x, ClassLoader:aquireInstance("GameConfig").Height)
	slot0.txtPanel:setPosition(cc.p(0, -21))
	slot0.txtPanel.sprite:setFlipY(true)
	slot0._textCannon:setPosition(0, -6)
end
