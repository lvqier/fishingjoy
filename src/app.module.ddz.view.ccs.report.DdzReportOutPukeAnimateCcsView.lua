slot2 = "DdzReportOutPukeAnimateCcsView"
DdzReportOutPukeAnimateCcsView = class(slot1)

DdzReportOutPukeAnimateCcsView.onCreationComplete = function (slot0)
	slot5 = slot0
...
DdzReportOutPukeAnimateCcsView.onCurIdxChanged = function (slot0)
	slot1 = pairs
	...
	if DDZ_SPECIALCT_TXT[slot1.ct] then
		function slot10()
			return
		end

		slot6 = slot0.controller.createSpineWithEvent(slot7, slot0.controller, DDZ_SPECIALCT_TXT[slot5])
		slot9 = slot6
		...
		slot0._spineTbl[DDZ_SPECIALCT_TXT[slot5]] = slot6
	end

	if DDZ_SPECIALCT_EFFECT[slot5] then
		function slot10()
			return
		end

		slot6 = slot0.controller.createSpineWithEvent(slot7, slot0.controller, DDZ_SPECIALCT_EFFECT[slot5])
		slot9 = slot6
		slot14 = slot0.pos0
		...
		slot0._spineTbl[DDZ_SPECIALCT_EFFECT[slot5]] = slot6

		if DDZ_SPECIALCT_EFFECT[slot5] == "ddzfeiji" then
			slot9 = slot0

			slot0.startFeijiCallTick(slot8)
		elseif DDZ_SPECIALCT_EFFECT[slot5] == "ddzzhadan" then
			slot9 = slot6
			slot12 = slot2
...
DdzReportOutPukeAnimateCcsView.stopFeijiCallTick = function (slot0)
...
DdzReportOutPukeAnimateCcsView.startFeijiCallTick = function (slot0)
	slot3 = slot0
...
DdzReportOutPukeAnimateCcsView.callFeijiParticle = function (slot0)
	if slot0._spineTbl.ddzfeiji then
		slot4 = slot1

		if not tolua.isnull(slot3) and slot1.getBoneData then
			slot5 = "ddzfeijipenqiwei"
