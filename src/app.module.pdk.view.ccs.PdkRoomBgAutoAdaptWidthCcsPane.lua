slot2 = "PdkRoomBgAutoAdaptWidthCcsPane"
PdkRoomBgAutoAdaptWidthCcsPane = class(slot1)

PdkRoomBgAutoAdaptWidthCcsPane.onCreationComplete = function (slot0)
...
PdkRoomBgAutoAdaptWidthCcsPane.onStrTxt = function (slot0)
	slot3 = slot0
