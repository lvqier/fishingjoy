slot2 = "PdkReportCodeCcsView"
PdkReportCodeCcsView = class(slot1)

PdkReportCodeCcsView.onCreationComplete = function (slot0)
	slot8 = slot0.view
...
PdkReportCodeCcsView.onZoomShowTweenComplete = function (slot0)
	slot3 = slot0
...
PdkReportCodeCcsView.hide = function (slot0, slot1, slot2)
...
PdkReportCodeCcsView.onRootClick = function (slot0)
	return
end

PdkReportCodeCcsView.onBtnClick = function (slot0, slot1)
...
PdkReportCodeCcsView.destroy = function (slot0)
