...
slot0 = class(slot1, "TgpdRollingText")
...
slot0.init = function (slot0)
	...
	if slot0._alignType == Candy.AlignType.AlignType_Left then
		slot8 = -slot0._width + slot0._everyWidth

		slot0._rootNode.setPositionX(slot6, slot0._rootNode)
	elseif slot0._alignType == Candy.AlignType.AlignType_Right then
		slot8 = 0

		slot0._rootNode.setPositionX(slot6, slot0._rootNode)
	elseif slot0._alignType == Candy.AlignType.AlignType_Center then
...
slot0.setNumber = function (slot0, slot1)
	slot0._inRolling = true
	slot2 = CandyFunc.splitNumber2(slot3)
...
slot0.startRolling = function (slot0)
	...
	slot3 = 0
	slot4 = CandyFunc.sign(slot5)
	slot7 = slot2
	slot6 = slot0._rollTime * slot0._timeScale

	if #CandyFunc.splitNumber2(slot2 - slot0._lastNumber) < #slot0._lastBitSequence then
		slot7 = 0
		slot8 = 1
		...
		for slot13 = #slot0._lastBitSequence, #slot5 + 1, -1 do
			...
			function slot31()
				...
				if slot1._alignType == Candy.AlignType.AlignType_Left then
				...
				elseif slot1._alignType == Candy.AlignType.AlignType_Center then
...
slot0.startRolling2u = function (slot0)
	if #slot0._numberSequence > 0 and not slot0._inRolling then
		...
		assert(slot2, #slot0._lastBitSequence == #CandyFunc.splitNumber2(slot2 - slot0._lastNumber))
