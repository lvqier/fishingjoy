slot2 = "TgpdNoticeCcsPane"
TgpdNoticeCcsPane = class(slot1)

TgpdNoticeCcsPane.onCreationComplete = function (slot0)
	slot0._msg = {}
	slot0._msgGap = 100
	...
	slot3 = slot0
	slot8 = Candy.root .. "notice/jxlw_firetioskuangeffecta.atlas"
	slot4 = sp.SkeletonAnimation.createWithJsonFile(slot5, sp.SkeletonAnimation, Candy.root .. "notice/jxlw_firetioskuangeffecta.json")
	slot7 = slot4
	...
	slot0.fire = slot4
	slot9 = Candy.root .. "notice/jxlw_firetioskuangeffectb.atlas"
	slot5 = sp.SkeletonAnimation.createWithJsonFile(sp.SkeletonAnimation, sp.SkeletonAnimation, Candy.root .. "notice/jxlw_firetioskuangeffectb.json")
	slot8 = slot5
	...
	slot0.bg = slot5
	slot9 = Candy.root .. "notice/serial_firetipskuanglizi.plist"
...
TgpdNoticeCcsPane.onEnterExit = function (slot0, slot1)
	if slot1 == "enter" then
		slot4 = slot0
...
TgpdNoticeCcsPane.reset = function (slot0)
	slot4 = false
...
TgpdNoticeCcsPane.addMessage = function (slot0, slot1)
	slot0._msg[#slot0._msg + 1] = slot1
end

TgpdNoticeCcsPane.getMessageNumber = function (slot0)
	return #slot0._msg
end

TgpdNoticeCcsPane.update = function (slot0, slot1)
...
TgpdNoticeCcsPane.start = function (slot0)
...
TgpdNoticeCcsPane.hide = function (slot0)
	slot0._state = "hiding"
	slot6 = false
...
TgpdNoticeCcsPane.check = function (slot0)
...
TgpdNoticeCcsPane.stop = function (slot0)
	slot0._state = "hided"
	slot4 = false
...
TgpdNoticeCcsPane.showText = function (slot0)
	slot4 = 1
	...
	if table.remove(slot2, slot0._msg).lWinScore > 0 then
		...
		slot16 = nil
		slot9 = "#e9d265"
		slot4 = slot4 .. HtmlUtil.createColorTxt(slot7, "发大财啦！ ") .. HtmlUtil.createColorTxt(slot7, slot1.szNickName .. " ") .. HtmlUtil.createColorTxt(slot7, "在连环夺宝 ") .. HtmlUtil.createColorTxt(slot7, slot1.szServerName .. " ") .. HtmlUtil.createColorTxt(slot7, "中一举赢得") .. HtmlUtil.createArtNumDot(slot7, slot1.lWinScore, "#serial_notice_%s.png", nil, nil, nil) .. HtmlUtil.createImg(slot7, Candy.root .. "notice/image_coin.png", nil, nil, nil, 2, nil, nil, 15) .. HtmlUtil.createColorTxt(slot7, "!大家快来围观啊!")
	else
		slot9 = "#e9d265"
		slot9 = "#ef5cab"
		slot9 = "#e9d265"
		...
		slot16 = nil
		slot9 = "#e9d265"
		slot4 = slot4 .. HtmlUtil.createColorTxt(slot7, "天降横财！") .. HtmlUtil.createColorTxt(slot7, slot1.szNickName .. " ") .. HtmlUtil.createColorTxt(slot7, "在连环夺宝 ") .. HtmlUtil.createColorTxt(slot7, slot1.szServerName .. " ") .. HtmlUtil.createColorTxt(slot7, "中赢得累积奖") .. HtmlUtil.createArtNumDot(slot7, slot1.lJackpot, "#serial_notice_%s.png", nil, nil, nil) .. HtmlUtil.createImg(slot7, Candy.root .. "notice/image_coin.png", nil, nil, nil, 2, nil, nil, 15) .. HtmlUtil.createColorTxt(slot7, "，一举暴富！")
	end
