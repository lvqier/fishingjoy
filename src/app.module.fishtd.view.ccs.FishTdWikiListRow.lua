FishTdWikiListRow = class("FishTdWikiListRow")

FishTdWikiListRow.onCreationComplete = function (slot0)
...
FishTdWikiListRow.onBtnClick = function (slot0, slot1, slot2)
	return
end

FishTdWikiListRow.onScrollViewParentChanged = function (slot0)
...
FishTdWikiListRow.updateView = function (slot0)
	if slot0._data then
		for slot4, slot5 in ipairs(slot0._items) do
...
FishTdWikiListRow.getPushZoomView = function (slot0)
	return nil
end

FishTdWikiListRow.destroy = function (slot0)
	for slot4, slot5 in ipairs(slot0._items) do
