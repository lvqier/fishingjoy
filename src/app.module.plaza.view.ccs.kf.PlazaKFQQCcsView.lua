PlazaKFQQCcsView = class("PlazaKFQQCcsView")

PlazaKFQQCcsView.onCreationComplete = function (slot0)
...
PlazaKFQQCcsView.onBtnClick = function (slot0, slot1, slot2)
	...
	elseif slot1 == slot0.view.btnClose then
		slot0.model:setIsShowingKfQQ(false)
	end
end

PlazaKFQQCcsView.destroy = function (slot0)
