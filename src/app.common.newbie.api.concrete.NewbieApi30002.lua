slot2 = "NewbieApi30002"
NewbieApi30002 = class(slot1)

NewbieApi30002.ctor = function (slot0)
	slot4 = BaseNewbieApi
...
NewbieApi30002.start = function (slot0)
	slot4 = TIP_CHARGE_FINISH_TO_BANK
...
NewbieApi30002.onBtnClick = function (slot0)
	slot3 = slot0

	slot0.finish(slot2)
end

NewbieApi30002.destroy = function (slot0)
	slot4 = TIP_CHARGE_FINISH_TO_BANK
